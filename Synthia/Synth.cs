...
namespace Synthia
{
    public class Synth : ISampleProvider
    {
        ...
        public int SemitonesOsc1
        {
            set
            {
                _oscillators.ForEach(osc => osc.SemitonesOsc1 = value);
            }
        }
        ...
        public int SemitonesOsc2
        {
            set
            {
                _oscillators.ForEach(osc => osc.SemitonesOsc2 = value);
            }
        }
        ...
        public int SemitonesOsc3
        {
            set
            {
                _oscillators.ForEach(osc => osc.SemitonesOsc3 = value);
            }
        }
        ...
        public int OctaveOsc1
        {
            set
            {
                _oscillators.ForEach(osc => osc.OctaveOsc1 = value);
            }
        }
        ...
        public int OctaveOsc2
        {
            set
            {
                _oscillators.ForEach(osc => osc.OctaveOsc2 = value);
            }
        }
        ...
        public int OctaveOsc3
        {
            set
            {
                _oscillators.ForEach(osc => osc.OctaveOsc3 = value);
            }
        }
        ...
        public SynthSourcePlugin WaveFormOsc1
        {
           set
           {
                _oscillators.ForEach(osc => osc.FunctionOsc1 = value.GetSample);
           }
        }
       ...
       public SynthSourcePlugin WaveFormOsc2
       {
            set
            {
                _oscillators.ForEach(osc => osc.FunctionOsc2 = value.GetSample);
            }
       }
       ...
       public SynthSourcePlugin WaveFormOsc3
       {
           set
           {
                _oscillators.ForEach(osc => osc.FunctionOsc3 = value.GetSample);
            }
       }
